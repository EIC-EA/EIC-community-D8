...
context('User - Activity - My drafts', () => {
  ...
  specify('From HP click on my activity feed, click on my drafts and verify if I see my draft content', () => {
    visitMyDrafts();
    // Write in the search input our content draft title.
    cy.get('.ecl-filter-sidebar__item-field .ecl-text-input.ecl-text-input--m').type(contentDraftTitle)
    cy.wait(500)
