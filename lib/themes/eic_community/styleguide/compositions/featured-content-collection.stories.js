...
export const Events = () => FeaturedContentCollectionTemplate(FeaturedContentCollection.event);

export const Groups = () => FeaturedContentCollectionTemplate(FeaturedContentCollection.group);
