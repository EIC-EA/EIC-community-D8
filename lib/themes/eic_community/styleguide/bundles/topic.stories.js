...
import TeaserStoryTemplate from '@theme/patterns/compositions/story/story.teaser.html.twig';
    ...
    Object.assign(
      {
        ...
        topics: topics,
        contributors: Object.assign(contributors, {
          is_collapsible: true,
          title: 'Experts',
        }),
        content: '',
        ...
        related_stories: Object.assign(featuredContentCollection.story, {
          ...
          items: mockItems(
            {
              content: TeaserStoryTemplate(teaser.story),
            },
            2
          ),
        }),
