...
export const FullPublic = () =>
  FullTemplate({
    ...
    flagged_groups: featuredContentSections.flaggedGroups,
    flagged_projects: featuredContentSections.flaggedProjects,
    flagged_interests: featuredContentSections.flaggedInterests,
  });
