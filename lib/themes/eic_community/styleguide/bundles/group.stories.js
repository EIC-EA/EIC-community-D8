...
import GalleryFullTemplate from '@theme/patterns/compositions/gallery/gallery.full.html.twig';
import GalleryTemplate from '@theme/patterns/components/gallery.html.twig';
...
import galleryDetail from '@theme/data/gallery.data'
...
export const VideoFullPublic = () => VideoFullTemplate(
  Object.assign(
    overview,
    videoDetail
  )
...
export const GalleryFull = () => GalleryFullTemplate(
  Object.assign(
    overview,
    {
      editorial_header: {
      ...
      social_share: socialShare,
      topics: topics,
      content: GalleryTemplate(galleryDetail),
    },
  )
);
