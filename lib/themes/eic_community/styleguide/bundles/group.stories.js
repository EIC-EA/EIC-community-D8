    ...
    Object.assign(
      {
        highlights: {
          title: 'Highlights',
          description: editableField('Suggested content from the group administrator teams'),
          collapsible_label: 'Show more highlights',
          call_to_action: {
            link: {
          ...
          items: mockItems(
            {
              content: AttachmentTemplate(
                Object.assign(
                  {
                    extra_classes: 'ecl-attachment--has-compact-layout ecl-attachment--is-white',
                  },
                  attachment
                )
              ),
        ...
        latest_tags: Object.assign(
          {
            title: 'Latest content for you',
          },
          without(topics, 'title')
        ),
