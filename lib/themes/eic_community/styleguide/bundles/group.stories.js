...
import CancelUserInvitation from '@theme/patterns/compositions/confirmations/cancel_user_invitation.html.twig';
...
export const GroupOverviewPending = () =>
  GroupOverview({
    ...
    editorial_header: Object.assign({}, header, {
      actions: [
        {
          link: {
    ...
    subnavigation: Object.assign({}, subnavigation.overview, {
      items: [
        {
          link: {
            label: 'Overview',
        ...
        activity_stream: Object.assign(
          {
            modal: {
              ...
              description:
                'Are you sure you want to delete this activity from the activity stream? Important: this action cannot be undone.',
              actions: [
                {
                  link: {
        ...
        items: mockItems(
          ...
          { content: GalleryTeaserTemplate(teaser.gallery) },
          {
            content: GalleryTeaserTemplate(
              Object.assign({}, teaser.gallery, {
                images: [{ src: 'https://picsum.photos/320' }],
              })
            ),
          },
          {
...
export const FileListFullPrivate = () =>
  FileListFullTemplate(
    Object.assign({}, filelistDetail, {
      user: common.user,
      editorial_actions: {
        icon_file_path: common.icon_file_path,
        items: [
...
export const GroupEventDetailed = () =>
  GroupEventFullTemplate(
    Object.assign(
      {
        editorial_header: header,
        ...
        event_infos: {
          ...
          action: {
            ...
            text:
              'Get notified of the latest changes and take part in the discussion linked to this event.',
            action: {
              label: 'Sign up now',
              url: 'https://google.be',
            },
...
export const GroupInvitationCancellation = () =>
  GroupOverview({
    content: `
        ${CancelUserInvitation({
          title: 'Cancel user invitation',
          description: `You are about to cancel the group invitation sent to <a href="#">john.doe@eic.com</a> to join <a href="#">EIC&nbsp;Community&nbsp;Platform&nbsp;Group</a>.
          <br><br>Click the confirm cancellation button to complete this action.`,
          actions: [
            {
