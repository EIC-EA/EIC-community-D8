...
export const GroupOverviewPending = () =>
  ...
  export const GroupOverviewArchived = () =>
  GroupOverview({
    content: `${StateBannerTemplate({
      icon_file_path: common.icon_file_path,
      icon: {
      ...
      description: `<p>This group is archived from our community team.<br/>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>`,
    })}`,
    editorial_header: Object.assign(
      {},
      header,
