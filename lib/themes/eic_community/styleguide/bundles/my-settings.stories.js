  ...
  MySettingsTemplate(
    {
      ...
      flagged_groups: MySettingNav.InterestNotification('Your group notifications'),
      flagged_event: MySettingNav.InterestNotification('Your event notifications'),
      flagged_comments: MySettingNav.InterestNotification('Your comments notifications'),
    }
  );
