...
.js(`react/components/Block/CommentsDiscussion/entrypoint.js`, `dist/react/block/comments_discussion`)
...
.extract(['react', 'react-dom', 'react-router-dom', 'axios', '@material-ui', 'lodash-es', 'scheduler'], 'dist/react/vendor.js');
