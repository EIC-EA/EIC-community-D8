  ...
  render() {
    if (this.state.total === 0) {
      return <div className="ecl-comment-overview__wrapper">
        <span className="ecl-comment-overview__title">{this.translations.no_results}</span>
        {this.state.loading &&
        ...
        <p className="ecl-comment-overview__no-items">{window.drupalSettings.translations.title}</p>
      </div>
    }

    return <div className="ecl-comment-overview__wrapper">
      <span className="ecl-comment-overview__title">{this.translations.title}</span>
      {this.state.loading &&
      <CircularProgress style={{top: '50%', left: '50%', position: 'fixed', zIndex: '51'}} className="loader"
                        size={50}/>}
      <CommentForm addComment={this.addComment} commentText={this.state.commentText}
              ...
              <div className="ecl-comment  ecl-comment-thread__comment"
                ...
                <div className="ecl-comment__content">
                  <header className="ecl-comment__header">
                    ...
                    <CollapseActions flagComment={this.flagComment} updateComment={this.updateComment} comment={comment}/>
                  </header>
                  ...
                  <Comment.Actions>
                    ...
                    <span
                      ...
                      <span className="ecl-link__label">{`${this.translations.reply_to} ${comment.user_fullname}`}</span>
                    </span>
