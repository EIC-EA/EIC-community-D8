...
import {hasPermissionApi} from "../Services/Permissions";
...
class TopAnswer extends React.Component {
  ...
  render() {
    if (parseInt(this.props.comment.is_soft_delete) !== 0) {
      const date = new Date(Date.parse(this.props.comment.deletion_date));
            ...
            <header className="ecl-comment__header">
              <div className="ecl-comment__header-main">
                ...
                <div className="ecl-timestamp ecl-comment__timestamp ecl-timestamp--meta">
                      ...
                      />
                  <time className="ecl-timestamp__label">{timeDifferenceFromNow(this.props.comment.created_timestamp)}</time>
                </div>
              </div>

              <CollapseActions deleteComment={this.props.deleteComment} flagComment={this.props.flagComment} updateComment={this.props.updateComment} comment={this.props.comment}/>
            </header>
                ...
                <div className="ecl-comment__actions">
                  ...
                  <div className="ecl-comment__action">
                    {this.state.canLike ? <a
                      style={{ cursor: 'pointer'}}
                      dangerouslySetInnerHTML={{__html: svg('like', 'ecl-icon--xs ecl-teaser__stat-icon') + 'Like'}}
