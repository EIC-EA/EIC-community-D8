        ...
        <div className="ecl-comment  ecl-comment-thread__comment"
          ...
          <div className="ecl-comment__content">
            <header className="ecl-comment__header">
              <div className="ecl-comment__header-main">
                <div className="ecl-comment__author-info">
                  <a href={this.props.comment.user_url} className="ecl-link ecl-link--standalone ecl-comment__author-name">{this.props.comment.user_fullname}</a>
                  {this.props.comment.user_top_contributor && <TopContrib toolTip={false} label={this.props.comment.user_top_contributor.label} />}
                  {this.props.comment.user_top_contributor && (
            ...
            <div className="ecl-comment__main">
              <div className="ecl-editable-wrapper" dangerouslySetInnerHTML={{__html: isCommentHidden(this.props.comment) ? `<b>${this.props.comment.text}</b>` : this.props.comment.text}}/>
