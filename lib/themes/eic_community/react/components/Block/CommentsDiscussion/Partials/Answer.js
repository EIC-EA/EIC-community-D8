      ...
      <div className="ecl-comment ecl-comment--is-reply ecl-comment-thread__comment" id={child.comment_id}>
        ...
        <div className="ecl-comment__content">
          <header className="ecl-comment__header">
            ...
            <CollapseActions parentId={this.props.parentId} updateComment={this.props.updateComment} comment={child}/>
          </header>
              ...
              <div className="ecl-comment__stats">
                <div className="ecl-comment__stat">
                  <a
                    ...
                    onClick={(e) => this.props.likeComment(child.comment_id, child.likes.hasAccountLike ? 'unflag' : 'flag')}
                  />
      ...
      <CommentAction>
        {this.props.level < 2 && <div>
          <span
            ...
            <span className="ecl-link__label">{`Reply to ${child.user_fullname}`}</span>
          </span>
        </div>
        }
