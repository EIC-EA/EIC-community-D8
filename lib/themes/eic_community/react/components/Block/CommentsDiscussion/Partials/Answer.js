            ...
            <div className="ecl-comment__header-main">
              ...
              <div className="ecl-comment__author-info">
                <a href={child.user_url}
                   className="ecl-link ecl-link--standalone ecl-comment__author-name">{child.user_fullname}</a> <TopContrib />
                <span className="ecl-comment__origin">{getTranslation('in_reply_to')}&nbsp;</span>
                <a href={`${this.props.parent.user_url}`}
                   className="ecl-link ecl-link--standalone ecl-comment__author-name">{this.props.parent.user_fullname}</a> <TopContrib />
              </div>
