          ...
          <form onSubmit={(e) => props.addComment(e, props.parentComment)}>
            <div className="ecl-form-group">
              <label className="ecl-comment-form__textarea-label ecl-form-label"
                     htmlFor="ecl-comment-form-reply">Reply</label>
              <div className="ecl-comment-form__textarea-wrapper">
                <textarea onChange={(e) => props.onChangeCommentText(e.target.value, props.parentComment)} value={props.commentText || props.commentTextReply} className="ecl-text-area ecl-comment-form__textarea" id="ecl-comment-form-reply" name=""
                          placeholder="Type your message here..." />
              </div>
            </div>
            <div className="ecl-comment-form__toolbar">
              <div className="ecl-comment-form__toolbar-main">
                <button className="ecl-button ecl-button--primary ecl-comment-form__submit" type="submit">Publish
                </button>
              </div>
            </div>
          </form>
