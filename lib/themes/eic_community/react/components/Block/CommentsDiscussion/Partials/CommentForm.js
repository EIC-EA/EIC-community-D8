        ...
        <div className="ecl-author ecl-author--is-default  ecl-author--hide-info">
          <div className="ecl-author__information">
                <span className="ecl-author__label ">
                      <a href={window.drupalSettings.overview.user.url}
          ...
          <div className="ecl-author__aside">
            <a href={window.drupalSettings.overview.user.url} className="ecl-author__media-wrapper">
              <figure className="ecl-media-container ecl-author__media">
                <img alt={window.drupalSettings.overview.user.fullname} className="ecl-media-container__media" src={window.drupalSettings.overview.user.avatar}/>
              </figure>
            </a>
          </div>
        </div>
