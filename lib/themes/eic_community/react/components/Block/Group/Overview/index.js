        ...
        <div className="ecl-base-layout ecl-base-layout--contain ">
          <div className="ecl-base-layout__content">
            <div className="ecl-base-layout__main">
              <main>
                <div className="ecl-teaser-overview ecl-teaser-overview--has-compact-layout ecl-teaser-overview--has-columns">
                  <Results
                ...
                <Pagination total={Math.ceil(this.state.total / this.state.resultsPerPage)} page={this.state.page}
                            changePage={this.changePage}/>
              </main>
            </div>
            <Sidebar translations={this.state.translations} facets={this.state.facets} updateFacet={this.updateFacet}
