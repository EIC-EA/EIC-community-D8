...
const ShareElement = ({endpoint, settings, groupsUrl}) => {
  ...
  return (
    <>
      ...
      {
        showModal &&
        <ShareModal groupsUrl={groupsUrl} settings={settings} handleChange={handleChange} handleSubmit={handleSubmitData} setShowModal={setShowModal} selectValue={selectValue} />
      }
    </>
  )
}
