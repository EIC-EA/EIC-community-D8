        ...
        <div className="ecl-base-layout ecl-base-layout--contain ">
          <div className="ecl-base-layout__content">
            <div className="ecl-base-layout__main">
              <main>
                <div className={`ecl-teaser-overview ecl-teaser-overview--has-columns ${this.props.layout === 'compact' && 'ecl-teaser-overview--has-compact-layout group--' + this.state.datasource}`}>
                  <Results
