            ...
            <div className="ecl-base-layout__main">
              <main>
                <div className={layoutClass}>
                  ...
                  />
                  {this.props.allowPagination === 0 && <LoadMore results={this.state.results} translations={this.state.translations} changePage={this.changePage} numFound={this.state.total} page={this.state.page} />}
                  <TopOptions
