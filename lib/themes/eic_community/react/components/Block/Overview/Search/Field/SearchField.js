          ...
          <div className="ecl-filter-sidebar__item-fields">
            <div className="ecl-filter-sidebar__item-field">
              <div className="ecl-form-group">
                <input placeholder={this.props.translations.search_placeholder} value={this.props.searchText} onChange={e => this.handleChange(e)} className="ecl-text-input ecl-text-input--m" type="text"/>
                <button
                  type='submit'
