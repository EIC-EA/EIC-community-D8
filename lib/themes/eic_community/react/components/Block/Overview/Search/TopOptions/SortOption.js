          ...
          >
            ...
            {Object.entries(this.props.sortSettings).map((value) => {
              ...
              return <React.Fragment key={value[1]} >
                {typeof window.drupalSettings.translations.sources.sort[ascKey] !== "undefined" && <option value={ascKey}>{`${window.drupalSettings.translations.sources.sort[ascKey]}`}</option>}
                {typeof window.drupalSettings.translations.sources.sort[descKey].length !== "undefined" && <option value={descKey}>{`${window.drupalSettings.translations.sources.sort[descKey]}`}</option>}
              </React.Fragment>
            })}
          </select>
