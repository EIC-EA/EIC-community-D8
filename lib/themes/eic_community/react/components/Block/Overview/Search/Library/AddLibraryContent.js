  ...
  render() {
    ...
    return (
      <div className="ecl-editorial-header__actions">
        <div className="ecl-editorial-header__action ecl-editorial-header__action--full-width">
          <div
            className="ecl-collapsible-options ecl-collapsible-options--aligns-from-right ecl-collapsible-options--actions ecl-collapsible-options--full-width">
                ...
                <div className="ecl-collapsible-options__items">
                  <div className="ecl-collapsible-options__item">
                    ...
                    <a href={`${this.props.currentGroupUrl}/content/create/group_node%3Adocument?destination=${uri}`}
                      ...
                      <svg className="ecl-icon ecl-icon--xs ecl-link__icon" focusable="false" aria-hidden="true">
                      </svg>
