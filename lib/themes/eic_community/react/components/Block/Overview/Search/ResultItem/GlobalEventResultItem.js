...
const GlobalEventResultItem = ({result}) => {
  ...
  if (result.ss_group_visibility_label) {
    groupVisibilityLabel = result.ss_group_visibility_label;
    groupClass = result.ss_group_visibility_label && result.ss_group_visibility_label.toLowerCase();
  }
                ...
                <div className="ecl-teaser__tags-wrapper">
                  <div className="ecl-teaser__tags">
                      ...
                      {groupVisibilityLabel && (
                        <div className="ecl-teaser__tag">
                          <span className={`ecl-tag ecl-tag--display ecl-tag--is-${groupClass}`}>
                            {groupVisibilityLabel}
                          </span>
                        </div>
                        )}
