...
const EventStreamResultItem = (props) => {
  ...
  return <ResultItemWrapper
    ...
    <span dangerouslySetInnerHTML={{__html: svg('calendar', 'ecl-icon ecl-icon--s ecl-activity-stream__item__icon')}} />
    {!props.isAnonymous ? (
      <span
...
export default EventStreamResultItem;
