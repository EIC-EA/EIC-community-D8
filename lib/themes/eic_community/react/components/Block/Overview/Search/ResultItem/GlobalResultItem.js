            ...
            <div className="ecl-teaser__content">
              ...
              <div className="ecl-teaser__details">
                <div className="ecl-teaser__detail">
                  ...
                  created a new <span className="ecl-teaser__detail-type">{this.props.result.ss_global_content_type.replace(/_/g, " ")}</span>
              ...
              <p className="ecl-teaser__description" dangerouslySetInnerHTML={{__html: this.props.result.tm_X3b_en_rendered_item}} />
            </div>
            ...
            <div className="ecl-teaser__meta-footer">
              <div className="ecl-teaser__stats">
                ...
                {this.props.result.ss_content_type === 'document' && <div className="ecl-teaser__stat">
                  ...
                  <span className="ecl-teaser__stat-value">{this.props.result.its_document_download_total}</span>
                </div>}
              </div>
            </div>
          </div>
