...
class ActivityStreamResultItem extends React.Component {
  ...
  getStatistics() {
    ...
    axios.get(endpoint, {
      params: {
        bundle: this.props.result.ss_type,
      ...
      >
        <span
          dangerouslySetInnerHTML={{
            __html: svg(actionType[this.props.result.ss_type.toLowerCase()].svg, 'ecl-icon ecl-icon--s ecl-activity-stream__item__icon'),
          }}
        />
        {!this.props.isAnonymous ? (
          <span
            ...
            dangerouslySetInnerHTML={{
              __html: `<a href="${this.props.result.ss_global_user_url}">${fullname}</a> ${actionType[this.props.result.ss_type.toLowerCase()].label} <a href="${this.props.result.ss_path}">${this.props.result.ss_title}</a>`,
            }}
          />
        ) : (
          <span
            className="ecl-activity-stream__item__description"
            dangerouslySetInnerHTML={{
              __html: `${fullname} ${actionType[this.props.result.ss_type.toLowerCase()].label} <a href="${this.props.result.ss_path}">${this.props.result.ss_title}</a>`,
            }}
          />
        )}
