        ...
        <div className={`ecl-discussion-thread ${isHighlighted && 'ecl-discussion-thread--is-highlighted'}`}>
            ...
            <div className="ecl-discussion-thread__image-wrapper">
              <div
                ...
                <div className="ecl-author__aside">
                  <a href="" className="ecl-author__media-wrapper">
                    <figure className="ecl-media-container ecl-author__media"><img alt={`Avatar image of ${fullname}`}
                                                                                   className="ecl-media-container__media"
                                                                                   src={this.props.result.ss_content_author_image} />
                    </figure>
                  </a>
                </div>
              </div>
          ...
          <div className="ecl-discussion-thread__footer">
            <div className="ecl-discussion-thread__meta">
                  <span className="ecl-discussion-thread__started-by-label">
            Started by
          </span>
          ...
          {this.state.comment.text && this.state.comment.text.length > 0 && <div className="ecl-discussion-thread__featured-items">
