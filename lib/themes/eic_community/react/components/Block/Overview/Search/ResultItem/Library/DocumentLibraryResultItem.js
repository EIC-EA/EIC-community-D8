...
class DocumentLibraryResultItem extends React.Component {
  ...
  render() {
    ...
    return (<div className="ecl-teaser ecl-teaser--filelist ecl-teaser--is-highlightable ecl-teaser--is-highlighted ">
          ...
          <div className="ecl-teaser__meta-header">
            <div className="ecl-teaser__meta-column">
              <div className="ecl-content-type-indicator ecl-teaser__type">
                <span className="ecl-content-type-indicator__label">File</span>
              </div>
            </div>
          </div>
          <div className="ecl-teaser__content">
            ...
            <div className="ecl-teaser__meta-content">
              ...
              <div className="ecl-teaser__meta-content-item">
                ...
                <a href={this.props.result.ss_global_user_url}>Uploaded by {this.props.result.ss_global_fullname}</a></div>
            </div>
            <div className="ecl-highlight ecl-highlight--is-highlighted">
              <a href="#">
