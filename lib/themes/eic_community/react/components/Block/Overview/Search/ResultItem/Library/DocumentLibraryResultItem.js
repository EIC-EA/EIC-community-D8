          ...
          <div className="ecl-teaser__content">
            <h2 className="ecl-teaser__title">
              <a href={this.props.result.ss_url}>
                <span className="ecl-teaser__title-overflow"><span>{this.props.result.tm_global_title}{filenames && filenames.length > 1 && ` (${Drupal.t('@count files in total', {'@count': filenames.length}, {context: 'eic_group'})})`}</span></span>
              </a>
            </h2>
