...
export default function StoryResultItem(props) {
  ...
  const storyTypeLabel = props.result.ss_content_field_story_type_string;
  ...
  const contentTypeLabel = showStoryTypeTag ? 'call' : props.result.ss_content_type;
      ...
      <div className="ecl-teaser__main-wrapper">
        <div className="ecl-teaser__meta-header">
          <div className="ecl-teaser__meta-column">
            ...
            {showStoryTypeTag && storyTypeLabel && (
