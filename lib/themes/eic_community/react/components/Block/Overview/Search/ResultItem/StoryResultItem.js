...
export default function StoryResultItem(props) {
  ...
  const storyTypeLabel = props.result.sm_content_field_story_type_string;
  const allowedStoryTypeIds = window.drupalSettings.storyTypes; // Type "Call" (Open call / Partner Call)
