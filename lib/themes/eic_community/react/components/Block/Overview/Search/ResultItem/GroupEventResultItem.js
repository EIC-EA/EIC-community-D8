          ...
          <div className="ecl-teaser__stats-wrapper">
            <div className="ecl-teaser__stats">
              <div className="ecl-teaser__stat">
                <div className="ecl-teaser__stat-icon" dangerouslySetInnerHTML={{__html: svg('comment', 'ecl-icon ecl-icon--grey ecl-icon--xs ecl-link__icon')}} />
                <span className="ecl-teaser__stat-label">Comments</span>
                <span className="ecl-teaser__stat-value">20</span>
              </div>
              <div className="ecl-teaser__stat">
                <div className="ecl-teaser__stat-icon" dangerouslySetInnerHTML={{__html: svg('like', 'ecl-icon ecl-icon--grey ecl-icon--xs ecl-link__icon')}} />
