...
const DocumentStreamResultItem = (props) => {
  const fullname = `${props.result.ss_author_first_name} ${props.result.ss_author_last_name}`;

  return <ResultItemWrapper showDeleteModal={props.showDeleteModal} messageId={props.result.its_message_id} result={props.result}>
