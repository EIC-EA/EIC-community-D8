        ...
        <div className="ecl-teaser ecl-teaser--group ecl-teaser--project">
          ...
          <div className="ecl-teaser__sidebar">
            ...
            {this.props.result.its_project_grant_agreement_id !== undefined &&
              <div className="ecl-u-mb-s">
                <a href={this.props.result.its_project_grant_agreement_id} className="ecl-link ecl-link--standalone ecl-link--icon ecl-link--icon-before ecl-link--button ecl-link--button-primary ecl-u-width-100 ">
