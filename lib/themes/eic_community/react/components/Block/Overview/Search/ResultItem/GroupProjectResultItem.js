              ...
              JSON.parse(this.props.result.ss_group_project_fields_of_science).map((item) => (
                <div key={item.machine_readable_name} className={`ecl-field-of-science ecl-field-of-science--${item.machine_readable_name}`}>
                  <div className="ecl-field-of-science__icon">
                    <svg
                      className="ecl-icon ecl-icon--m ecl-link__icon ecl-link--external"
                      focusable="false"
                      aria-hidden="true"
                      dangerouslySetInnerHTML={{__html: `<use xlink:href=themes/custom/eic_community/dist/images/sprite/custom/sprites/custom.svg#fields_of_science--${item.machine_readable_name}></use>`}}
                    />
                  </div>
