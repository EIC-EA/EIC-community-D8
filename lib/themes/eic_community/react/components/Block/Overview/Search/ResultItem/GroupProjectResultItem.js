...
class GroupProjectResultItem extends React.Component {
  ...
  render() {
    ...
    // var fieldsOfScience = '';
    // if (this.props.result.ss_group_project_fields_of_science) {
    //   fieldsOfScience = JSON.parse(this.props.result.ss_group_project_fields_of_science)
    //   // console.log(fieldsOfScience);
    // }
        ...
        <div className="ecl-teaser ecl-teaser--group ecl-teaser--project">
            ...
            <div className="ecl-teaser__content-wrapper">
              <div className="ecl-teaser__content">
                ...
                <div className="ecl-teaser__meta-header">
                  <span
                    className="ecl-u-mr-l"><strong>ID: </strong>{this.props.result.its_project_grant_agreement_id}</span>
          ...
          <div className="ecl-teaser__sidebar">
            {this.props.result.ss_group_project_fields_of_science !== undefined &&
              JSON.parse(this.props.result.ss_group_project_fields_of_science).map((item, index) => (
                <div key={index}>{item.name}</div>
              // console.log(item.name);
                // {item.vid} {item.machine_readable_name}
                // <div className="ecl-u-mb-s">
                //   <a href={fieldsOfScience} className="ecl-link ecl-link--standalone ecl-link--icon ecl-link--icon-before ecl-link--button ecl-link--button-primary ecl-u-width-100 ">
...
// <div className="ecl-field-of-science ecl-field-of-science--social-sciences">
...
//   </div>
//   <div className="ecl-field-of-science__label">
//     <div>Social sciences</div>
//   </div>
// </div>
//
//
//  <use xlink:href="themes/custom/eic_community/dist/images/sprite/custom/sprites/custom.svg#custom--group_circle"></use>


// <div class="ecl-field-of-science {{ modifier ? 'ecl-field-of-science--' ~ modifier }}">
//   <div class="ecl-field-of-science__icon">{{ source(eic_images_path ~ '/fields-of-science/' ~ filename ~ '.svg', ignore_missing = true) }}</div>
//   <div class="ecl-field-of-science__label">{{ label }}</div>
// </div>
