...
const StatisticsFooterResult = (props) => {
  return <div className="ecl-teaser__stats">
    <div className="ecl-teaser__stat">
      ...
      <span className="ecl-teaser__stat-value">{props.result.its_content_comment_count || 0}</span>
    </div>
    <div className="ecl-teaser__stat">
      ...
      <span className="ecl-teaser__stat-value">{props.result.its_statistics_view || 0}</span>
    </div>
    <div className="ecl-teaser__stat">
    ...
    {props.result.ss_content_type === 'document' && <div className="ecl-teaser__stat">
      ...
      <span className="ecl-teaser__stat-value">{props.result.its_document_download_total || 0}</span>
    </div>}
  </div>
}
