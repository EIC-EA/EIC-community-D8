          ...
          <div className="ecl-filter-sidebar__main">
            ...
            <div className="ecl-filter-sidebar__items">
...

              {
                ...
                <DateField dateRange={this.props.dateRange} translations={this.props.translations} updateDateRange={this.props.updateDateRange} handleDateClear={this.props.handleDateClear} handleCalendarClose={this.props.handleCalendarClose} />
              }
              ...
              {this.props.facets && Object.keys(this.props.facets).length !== 0 && Object.entries(this.props.facets).map((values) => {
                ...
                {this.translations.sources[this.sourceBundle].facet[values[0]]}
