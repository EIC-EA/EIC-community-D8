        ...
        <div className="ecl-comment__author">
          <div className="ecl-author ecl-author--is-default  ecl-author--hide-info">
            ...
            <div className="ecl-author__aside">
              <a href={props.comment.author_url} className="ecl-author__media-wrapper">
                <figure className="ecl-media-container ecl-author__media"><img alt={`Avatar of ${props.comment.author}`}
