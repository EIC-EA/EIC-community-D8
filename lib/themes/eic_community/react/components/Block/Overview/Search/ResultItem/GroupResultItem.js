...
class GroupResultItem extends React.Component {
  ...
  render() {
    ...
    let groupClass = 'public' !== this.props.result.ss_group_visibility ? 'private' : 'public';
          ...
          <div className="ecl-teaser__main-wrapper">
            <div className="ecl-teaser__meta-header">
              {!this.props.isAnonymous && <span
                className={`ecl-tag ecl-tag--display ecl-tag--is-${groupClass}`}>{this.props.result.ss_group_visibility !== 'public' ? this.props.translations.private : this.props.translations.public}</span>}
            </div>
            <div className="ecl-teaser__content-wrapper">
              <div className="ecl-teaser__content">
                <h2 className="ecl-teaser__title">
                  <a href={this.props.result.ss_group_url}>{this.props.result.ss_group_label_string}</a>
                </h2>
                ...
                <div className="ecl-author ecl-author--is-tiny  ecl-teaser__meta">
                  <div className="ecl-author__information">
                    <span className="ecl-author__label ">
                          <a href={this.props.result.ss_group_user_url}
                ...
                <div className="ecl-timestamp ">
                  ...
                  <time className="ecl-timestamp__label">Last activity {timeDifferenceFromNow(this.props.result.ss_drupal_timestamp)}</time>
                </div>
              </div>
            </div>
