...
class GroupResultItem extends React.Component {
  ...
  render() {
    ...
    const groupImageFallback = this.props.type === 'organisation' ? '<use xlink:href="themes/custom/eic_community/dist/images/sprite/custom/sprites/custom.svg#custom--organisation_circle"></use>' : '<use xlink:href="themes/custom/eic_community/dist/images/sprite/custom/sprites/custom.svg#custom--group_circle"></use>';
            ...
            <figure className="ecl-teaser__image-wrapper">
              ...
              {this.props.result.ss_group_teaser_url_string === undefined &&
                <div className="ecl-teaser__image-fallback-wrapper">
                  <svg className="ecl-icon ecl-icon--3xl" focusable="false" aria-hidden="true"
                       dangerouslySetInnerHTML={{__html: groupImageFallback}}/>
                </div>
              }
            </figure>
          </a>
            ...
            <div className="ecl-teaser__content-wrapper">
              <div className="ecl-teaser__content">
                <h2 className="ecl-teaser__title">
                  <a href={itemUrl}>{this.props.result.tm_global_title}</a>
                </h2>
