    ...
    <>
      <div className={"ecl-gallery__data"}>
        ...
        <div className={"ecl-gallery__data__actions"}>
          ...
          <a className={"ecl-link ecl-link--standalone ecl-link--button ecl-link--button-primary ecl-link--icon ecl-link--svg"} href={file.image.src} target="_blank" > <GetAppIcon /> Download </a>
        </div>
      </div>
