    ...
    return (
      <>
        {this.props.hidden !== true &&
          <Row translations={this.props.translations} parentIndex={this.props.rowIndex} row={this.props.row}
               showChildren={this.state.showChildren} setShowChildren={this.setShowChildren}
               unsubscribe={this.props.unsubscribe} showUnsubscribeModal={this.props.showUnsubscribeModal}/> }
        {(this.props.hidden !== true && this.state.showChildren) && this.state.row?.items?.map((item, index) => <Row translations={this.props.translations} parentIndex={this.props.rowIndex} rowIndex={index} row={item} isChild={true} unsubscribe={this.props.unsubscribe} key={index} showUnsubscribeModal={this.props.showUnsubscribeModal} />)}
      </>
    )
  }
}
      ...
      <>
        <tr onClick={() => !this.props.isChild ? this.props.setShowChildren(!this.props.showChildren) : false } className={classNames('ecl-my-notifications-management__table__item', {
          ...
          <td className="ecl-my-notifications-management__table__status">
            <div>
              <Toggle checked={this.state.toggle} name={this.props.row.name.label} translations={this.props.translations} />
