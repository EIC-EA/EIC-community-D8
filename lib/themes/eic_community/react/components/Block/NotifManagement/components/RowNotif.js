    ...
    return (
      <>
        {this.props.hidden !== true &&
          <Row translations={this.props.translations}
          ...
          /> }
        {(this.props.hidden !== true && this.state.showChildren) && this.state.row?.items?.map((item, index) =>
          <Row translations={this.props.translations}
               parentIndex={this.props.rowIndex}
               rowIndex={index}
               row={item}
      ...
      <>
        <tr onClick={() => !this.props.isChild ? this.props.setShowChildren(!this.props.showChildren) : false } className={classNames('ecl-my-notifications-management__table__item', {
          ...
          <td className="ecl-my-notifications-management__table__status">
            <div>
              <Toggle url={this.props.row.update_url}
          ...
          {this.props.unsubscribe &&
            <td className="ecl-my-notifications-management__table__unsubscribe">
              <button onClick={(e) => {e.preventDefault(); e.stopPropagation(); this.props.showUnsubscribeModal(this.props.row.id, this.props.row.name.label, this.props.parentIndex, this.props.rowIndex, this.props.row.unsubscribe_url); }}>{this.props.translations.notification_unsubscribe}</button>
            </td>
          }
        </tr>
      </>
