...
const Modal = ({groups}) => {
  ...
  const [selectValue, setSelectValue] = useState("00")
  const [showModal, setShowModal] = useState(false)

  return (
    <>
      <button onClick={() => setShowModal(!showModal)}>show</button>
      <div className="ecl-viewport__modal" style={{display: showModal ? "flex" : "none"}}>
          ...
          <div className="ecl-form">
            <div className="ecl-form-group">
              ...
              <div className="ecl-select__container ecl-select__container--full">
                <select className="ecl-select" id="modal-groups" name="modal-groups" onChange={(e) => setSelectValue(e.target.value)} value={selectValue}>
            ...
            <div className="ecl-form-group">
              ...
              <div className="ecl-help-block">Your description can contain up to 300 characters.</div>
              <textarea className="ecl-text-area ecl-text-area--full" rows="4" required />
            </div>
          </div>
          ...
          <div className="ecl-inline-actions">
            <div className="ecl-inline-actions__items">
              <div className="ecl-inline-actions__item">
                <a href="?delete-comment=1" className="ecl-link ecl-link--default ecl-link--button ecl-link--button-primary">
                  Share
                </a>
              </div>
              <div className="ecl-inline-actions__item">
                <a href="?delete-comment=1"
