...
class EntityTree extends React.Component {
  constructor(props) {
    ...
    // this.showEntityList = this.showEntityList.bind(this);
  }
  ...
  addChip(value) {
    ...
    this.props.onChange && this.props.onChange(selectedTerms);
  ...
  render() {
    return (
      <div className="entity-tree" ref={this.firstEl}>
        ...
        <p className="ecl-form-label">{this.props.translations.your_values}</p>
        ...
        <Search
          targetEntity={this.props.targetEntity}
          createTermUrl={this.props.createTermUrl}
