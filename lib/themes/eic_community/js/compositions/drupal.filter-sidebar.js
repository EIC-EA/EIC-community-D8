...
(function (ECL, Drupal) {
  ...
  function defineFilterSidebar(filterSidebar) {
    ...
    filterSidebarExpand.addEventListener('click', (event) => {
      filterSidebar.setAttribute('aria-expanded', 'true');
    });

    // Implements collapse feature for current filterSidebar element.
    filterSidebarCollapse.addEventListener('click', (event) => {
  ...
  function defineFilterSidebarItem(filterSidebarItem) {
    ...
    filterSidebarItemLabel && filterSidebarItemLabel.addEventListener('click', toggleItem);
    filterSidebarItemLabel &&
    ...
    filterSidebarItemExpand && filterSidebarItemExpand.addEventListener('click', expand);

    // Implements the collapse methods for the current filter fields.
    filterSidebarItemCollapse && filterSidebarItemCollapse.addEventListener('click', collapse);
