 ...
 */
function eic_theme_helper_post_update_use_retina_image_styles(array &$sandbox): void {
 ...
 */
function eic_theme_helper_post_update_00001() {
  ...
  // not executed twice on sites where eic_theme_helper_post_update_00001()
  // was already ran. We also keep an empty eic_theme_helper_post_update_20002()
  // since, in all cases, we need to invalidate that hook.
  $original_name = 'eic_theme_helper_post_update_20002';
 ...
 */
function eic_theme_helper_post_update_20001() {
...
/**
 * Empty hook. Moved to eic_theme_helper_post_update_00001().
 */
function eic_theme_helper_post_update_20002() {
  // @see eic_theme_helper_post_update_00001() for more information.
}

/**
 * Add default component library theme setting.
 */
function eic_theme_helper_post_update_20003() {
 ...
 */
function eic_theme_helper_post_update_20004() {
 ...
 */
function eic_theme_helper_post_update_20005() {
 ...
 */
function eic_theme_helper_post_update_20006() {
 ...
 */
function eic_theme_helper_post_update_20007(array &$sandbox) {
 ...
 */
function eic_theme_helper_post_update_20008(array &$sandbox) {
 ...
 */
function eic_theme_helper_post_update_20009(array &$sandbox) {
 ...
 */
function eic_theme_helper_post_update_20010() {
 ...
 */
function eic_theme_helper_post_update_20011(): void {
 ...
 */
function eic_theme_helper_post_update_20012() {
 ...
 */
function eic_theme_helper_post_update_20013() {
  ...
  $config->set('plugin', 'eic_theme_helper_site_navigation:main');
  $config->set('settings', [
    'id' => 'eic_theme_helper_site_navigation:main',
    'label' => $label,
 ...
 */
function eic_theme_helper_post_update_20014() {
  ...
  if ($block->getTheme() == 'oe_theme') {
    $block->setVisibilityConfig('eic_theme_helper_current_branding', [
      'id' => 'eic_theme_helper_current_branding',
 ...
 */
function eic_theme_helper_post_update_20015() {
