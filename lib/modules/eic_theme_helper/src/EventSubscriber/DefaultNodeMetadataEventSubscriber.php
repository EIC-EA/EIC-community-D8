...
namespace Drupal\eic_theme_helper\EventSubscriber;

use Drupal\Core\Entity\EntityRepositoryInterface;
use Drupal\Core\Entity\EntityTypeManagerInterface;
use Drupal\Core\Routing\RouteMatchInterface;
use Drupal\node\NodeInterface;
use Drupal\eic_theme_helper\Event\NodeMetadataEvent;
use Drupal\eic_theme_helper\PageHeaderMetadataEvents;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;

/**
 * Provides the node entity on the default node-related routes.
 *
 * @see \Drupal\eic_theme_helper\Plugin\PageHeaderMetadata\NodeViewRoutesBase
 */
class DefaultNodeMetadataEventSubscriber implements EventSubscriberInterface {
   ...
   *
   * @param \Drupal\eic_theme_helper\Event\NodeMetadataEvent $event
   *   The event.
   */
