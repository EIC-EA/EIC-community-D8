...
namespace Drupal\eic_theme_helper\ContextProvider;
...
use Drupal\eic_theme_helper\PageHeaderMetadataPluginManager;
...
class PageHeaderContext implements ContextProviderInterface {
   ...
   *
   * @var \Drupal\eic_theme_helper\PageHeaderMetadataPluginManager
   */
   ...
   *
   * @param \Drupal\eic_theme_helper\PageHeaderMetadataPluginManager $metadata_plugin_manager
   *   The page header metadata plugin manager.
   */
