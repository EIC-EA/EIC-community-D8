...
namespace Drupal\eic_theme_helper\Plugin\field_group\FieldGroupFormatter;
 ...
 *
 * @FieldGroupFormatter(
 *   id = "eic_theme_helper_in_page_navigation",
...
class InPageNavigation extends InPageNavigationBase {
  ...
  public function preRender(&$element, $rendering_object) {
    ...
    $element += [
      '#theme' => 'eic_theme_helper_in_page_navigation',
      '#title' => $this->getLabel(),
    ];
  ...
  protected function isInPageNavigationItem(string $group, array $rendering_object): bool {
    return isset($rendering_object['#fieldgroups'][$group]) && $rendering_object['#fieldgroups'][$group]->format_type === 'eic_theme_helper_in_page_navigation_item';
  }
