...
namespace Drupal\eic_theme_helper\Plugin\Condition;
 ...
 *
 * @Condition(
 *   id = "eic_theme_helper_current_component_library",
...
class CurrentComponentLibraryCondition extends ConditionPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['component_library'] = [
      ...
      '#description' => $this->t('Choose with which component library this condition should be met.'),
    ];
