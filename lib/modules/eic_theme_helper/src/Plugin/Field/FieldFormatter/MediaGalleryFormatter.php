...
namespace Drupal\eic_theme_helper\Plugin\Field\FieldFormatter;
...
use Drupal\eic_theme_helper\MediaDataExtractorPluginManagerInterface;
use Drupal\eic_theme_helper\Plugin\Field\FieldFormatter\MediaThumbnailUrlFormatter;
 ...
 *
 * @FieldFormatter(
 *   id = "eic_theme_helper_media_gallery",
...
class MediaGalleryFormatter extends MediaThumbnailUrlFormatter {
   ...
   *
   * @var \Drupal\eic_theme_helper\MediaDataExtractorPluginManagerInterface
   */
   ...
   *   The entity type bundle info.
   * @param \Drupal\eic_theme_helper\MediaDataExtractorPluginManagerInterface $mediaDataExtractorManager
   *   The media data extractor plugin manager.
   *
