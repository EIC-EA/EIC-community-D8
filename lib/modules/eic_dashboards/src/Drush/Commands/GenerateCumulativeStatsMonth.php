 ...
 * A Drush commandfile.
 */
final class GenerateCumulativeStatsMonth extends DrushCommands {
   ...
   */
  #[CLI\Command(name: 'eic_dashboards:command-name', aliases: ['foo'])]
  #[CLI\Argument(name: 'arg1', description: 'Argument description.')]
  #[CLI\Option(name: 'option-name', description: 'Option description')]
  #[CLI\Usage(name: 'eic_dashboards:command-name foo', description: 'Usage description')]
   ...
   */
  #[CLI\Command(name: 'eic_dashboards:token', aliases: ['token'])]
